 ...
 * Returns the currently selected actors in the level viewport / outliner.
 */
class UEEDITORMCP_API FGetSelectedActorsAction : public FEditorAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FMCPEditorContext& Context) override;
 ...
 * Lists all streaming sub-levels registered in the current persistent level.
 * Returns name, package path, loaded/visible state, streaming method.
 * Action ID: editor.get_streaming_levels
 */
class UEEDITORMCP_API FGetStreamingLevelsAction : public FEditorAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FMCPEditorContext& Context) override;
...
protected:
	virtual bool Validate(const TSharedPtr<FJsonObject>& Params, FMCPEditorContext& Context, FString& OutError) override { return true; }
	virtual FString GetActionName() const override { return TEXT("get_streaming_levels"); }
	virtual bool RequiresSave() const override { return false; }
};
 ...
 * Adds a level as a streaming sub-level to the current persistent level.
 * Params:
 *   level_path (string, required) - Package path, e.g. "/Game/Game/Levels/G_NYCity"
 *   streaming_method (string, optional) - "Blueprint" (default) or "Volume"
 * Action ID: editor.add_streaming_level
 */
class UEEDITORMCP_API FAddStreamingLevelAction : public FEditorAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FMCPEditorContext& Context) override;
...
protected:
	virtual bool Validate(const TSharedPtr<FJsonObject>& Params, FMCPEditorContext& Context, FString& OutError) override;
	virtual FString GetActionName() const override { return TEXT("add_streaming_level"); }
};


/**
 * FRemoveStreamingLevelAction
 * Removes a streaming sub-level from the current persistent level.
 * Params:
 *   level_path (string, required) - Package path of the level to remove
 * Action ID: editor.remove_streaming_level
 */
class UEEDITORMCP_API FRemoveStreamingLevelAction : public FEditorAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FMCPEditorContext& Context) override;
...
protected:
	virtual bool Validate(const TSharedPtr<FJsonObject>& Params, FMCPEditorContext& Context, FString& OutError) override;
	virtual FString GetActionName() const override { return TEXT("remove_streaming_level"); }
};


/**
 * FSetStreamingLevelMethodAction
 * Changes the streaming method on an existing streaming sub-level.
 * Params:
 *   level_path (string, required) - Package path of the level
 *   streaming_method (string, required) - "Blueprint" or "Volume"
 * Action ID: editor.set_streaming_level_method
 */
class UEEDITORMCP_API FSetStreamingLevelMethodAction : public FEditorAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FMCPEditorContext& Context) override;
...
protected:
	virtual bool Validate(const TSharedPtr<FJsonObject>& Params, FMCPEditorContext& Context, FString& OutError) override;
	virtual FString GetActionName() const override { return TEXT("set_streaming_level_method"); }
};


/**
 * FMoveActorToLevelAction
 * Moves an actor to a different level (persistent or streaming sub-level).
 * Params:
 *   actor_name (string, required) - Name of the actor to move
 *   dest_level (string, optional) - Package path of destination streaming level.
 *                                   Use "persistent" or omit to move to the persistent level.
 * Action ID: editor.move_actor_to_level
 */
class UEEDITORMCP_API FMoveActorToLevelAction : public FEditorAction
{
public:
	virtual TSharedPtr<FJsonObject> ExecuteInternal(const TSharedPtr<FJsonObject>& Params, FMCPEditorContext& Context) override;
...
protected:
	virtual bool Validate(const TSharedPtr<FJsonObject>& Params, FMCPEditorContext& Context, FString& OutError) override;
	virtual FString GetActionName() const override { return TEXT("move_actor_to_level"); }
};
