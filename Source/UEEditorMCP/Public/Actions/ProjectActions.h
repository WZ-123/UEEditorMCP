...
/**
 * Get Enhanced Input Action asset properties
 */
class UEEDITORMCP_API FGetInputActionAction : public FEditorAction
{
public:
	virtual FString GetActionName() const override { return TEXT("GetInputAction"); }
...
/**
 * Update Enhanced Input Action asset properties
 */
class UEEDITORMCP_API FUpdateInputActionAction : public FEditorAction
{
public:
	virtual FString GetActionName() const override { return TEXT("UpdateInputAction"); }
...
/**
 * Get Enhanced Input Mapping Context mappings
 */
class UEEDITORMCP_API FGetInputMappingContextAction : public FEditorAction
{
public:
	virtual FString GetActionName() const override { return TEXT("GetInputMappingContext"); }
