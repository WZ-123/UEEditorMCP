...
public class UEEditorMCP : ModuleRules
{
	public UEEditorMCP(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PrivateDependencyModuleNames.AddRange(new string[]
		{
			...
			// Niagara (ported from Monolith plugin) — runtime + editor types used by Private/Niagara/Monolith*Actions
			"Niagara",
			"NiagaraCore",
			"NiagaraEditor",
			"NiagaraShader",
		...
		// Niagara port — Private/Niagara contains Monolith*Actions sources that include
		// engine-private headers (NiagaraStackGraphUtilities, NiagaraSystemEditorData, etc.).
		PrivateIncludePaths.AddRange(new string[]
		{
			System.IO.Path.Combine(EngineDirectory, "Plugins", "FX", "Niagara", "Source", "NiagaraEditor", "Private"),
			System.IO.Path.Combine(EngineDirectory, "Plugins", "FX", "Niagara", "Source", "Niagara", "Private"),
		});
