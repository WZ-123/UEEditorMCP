...
class UEBridge:
    ...
    def get_input_action(self, name: str = None, *, path: str = None,
                         asset_path: str = None) -> dict:
        return self.call("get_input_action", name=name, path=path,
                         asset_path=asset_path)

    def update_input_action(self, name: str = None, *, path: str = None,
                            asset_path: str = None,
                            value_type: str = None,
                            accumulation_behavior: str = None,
                            consume_input: bool = None,
                            consume_legacy_mappings: bool = None,
                            reserve_all_mappings: bool = None,
                            trigger_when_paused: bool = None,
                            trigger_events_that_consume_legacy_keys: int = None,
                            description: str = None) -> dict:
        return self.call("update_input_action",
                         name=name, path=path, asset_path=asset_path,
                         value_type=value_type,
                         accumulation_behavior=accumulation_behavior,
                         consume_input=consume_input,
                         consume_legacy_mappings=consume_legacy_mappings,
                         reserve_all_mappings=reserve_all_mappings,
                         trigger_when_paused=trigger_when_paused,
                         trigger_events_that_consume_legacy_keys=trigger_events_that_consume_legacy_keys,
                         description=description)

    def get_input_mapping_context(self, name: str = None, *, path: str = None,
                                  asset_path: str = None) -> dict:
        return self.call("get_input_mapping_context", name=name, path=path,
                         asset_path=asset_path)
