        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "path": {"type": "string", "description": "Content browser path containing the asset (default: /Game/Input)"},
                    "asset_path": {"type": "string", "description": "Optional full asset path like /Game/Input/IA_Move or /Game/Input/IA_Move.IA_Move"}
                }
            }
        ),
        Tool(
            name="update_input_action",
...
TOOL_HANDLERS = {
    ...
    "get_input_action": "get_input_action",
    "update_input_action": "update_input_action",
    "get_input_mapping_context": "get_input_mapping_context",
